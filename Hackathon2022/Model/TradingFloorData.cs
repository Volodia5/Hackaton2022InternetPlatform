...
namespace HackatonInternetPlatform.Model
{
    ...
    internal class TradingFloorData
    {
        ...
        public bool UpdateRequest(int purchaserID,int requstID, string name = null, int count = -1, string productType = null, int cost = -1, char currency = ' ', string payMethod = null, string deliveryAdress = null, bool isValid = false)
        {
            int index = FindUserIndexById(purchaserID, _purchasers);
