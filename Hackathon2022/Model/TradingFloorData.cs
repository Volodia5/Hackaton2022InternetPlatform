...
namespace HackatonInternetPlatform.Model
{
    ...
    internal class TradingFloorData
    {
        ...
        public event Action TookPurchaser;
        public event Action TookSupplyer;
        public event Action TookRequest;
        public event Action TookSupplyOffer;
        ...
        public bool TakePurchaser()
        {
            return true;
        }

        public bool TakePurchasers()
        {
            return true;
        }
        #endregion
