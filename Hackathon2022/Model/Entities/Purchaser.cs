...
namespace HackatonInternetPlatform.Model
{
    ...
    internal class Purchaser : User, IReadOnlyPurchaser
    {
        ...
        public bool UpdateRequest(int id, string name = null, int count = -1, string productType = null, int cost = -1, char currency = ' ', string payMethod = null, string deliveryAdress = null, bool isValid = false)
        {
            int index = FindRequstIndexById(id);
