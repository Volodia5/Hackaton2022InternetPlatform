...
{
    //Сделать все связанное с запросами
    [Serializable]
    public class Request : IReadOnlyRequest
    {
        ...
        public void Update(string name = null, int count = -1, string productType = null, int cost = -1, char currency = ' ', string payMethod = null, string deliveryAdress = null, DateTime dateEnd = default, bool isValid = false)
        {
            if (name != null)
                Name = name;
            if (count != -1)
