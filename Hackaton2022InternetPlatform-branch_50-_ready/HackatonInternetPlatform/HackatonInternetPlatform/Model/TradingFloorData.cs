...
namespace HackatonInternetPlatform.Model
{
    ...
    public class TradingFloorData
    {
        ...
        public event Action<int> RemovedPurchaser;
        public event Action<int, string, string, string, string, string> UpdatedPurchaser;
        public event Func<int, IReadOnlyPurchaser> GotPurchaser;

        public event Action AddedSupplyer;
        public event Action<int, string, string, string, string, string> UpdatedSupplier;
        public event Action<int> RemovedSupplier;
        public event Func<int, IReadOnlySupplier> GotSupplier;

        public event Action AddedRequest;
        public event Action UpdatedRequest;
        public event Action RemovedRequest;
        public event Func<int, IReadOnlyRequest> GotRequest;

        public event Action AddedSupplyOffer;
        public event Action UpdatedSupplyOffer;
        public event Action RemovedSupplyOffer;
        public event Func<int, IReadOnlySupplyOffer> GotSupplyOffer;
        ...
        public bool UpdatePurchaser(int purchaserID, string fullName = null, string contactData = null, string legalInformation = null, string login = null, string password = null)
        {
            ...
            if (result)
                UpdatedPurchaser?.Invoke(purchaserID, fullName, contactData, legalInformation, login, password);
        ...
        public int GetPurchaserIdByLoginData(string login, string password)
        {
            foreach (var item in _purchasers)
            {
        ...
        public bool UpdateSupplier(int supplierID, string fullName = null, string contactData = null, string legalInformation = null, string login = null, string password = null)
        {
            ...
            if (result)
                UpdatedSupplier?.Invoke(supplierID, fullName, contactData, legalInformation, login, password);
        ...
        public int GetSupplierIdByLoginData(string login, string password)
        {
